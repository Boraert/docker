...
describe("CompanyRegistration", () => {
  ...
  test("POST /companyRegistrations", async () => {
    await request(app.getHttpServer())
      .post("/companyRegistrations")
      .send(CREATE_INPUT)
  ...
  test("GET /companyRegistrations", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /companyRegistrations/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/companyRegistrations"}/${nonExistingId}`)
  ...
  test("GET /companyRegistrations/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/companyRegistrations"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /companyRegistrations existing resource", async () => {
