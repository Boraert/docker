...
import { WebsiteVisitorCreateInput } from "./WebsiteVisitorCreateInput";
...
export class WebsiteVisitorControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: WebsiteVisitor })
  ...
  async create(
    @common.Body() data: WebsiteVisitorCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [WebsiteVisitor] })
  ...
  async findMany(@common.Req() request: Request): Promise<WebsiteVisitor[]> {
    const args = plainToClass(WebsiteVisitorFindManyArgs, request.query);
  ...
  async findOne(
    @common.Param() params: WebsiteVisitorWhereUniqueInput
  ...
  async update(
    @common.Param() params: WebsiteVisitorWhereUniqueInput,
    @common.Body() data: WebsiteVisitorUpdateInput
  ): Promise<WebsiteVisitor | null> {
    try {
