...
@ArgsType()
class UpdateWebsiteVisitorArgs {
  @Field(() => WebsiteVisitorWhereUniqueInput, { nullable: false })
  where!: WebsiteVisitorWhereUniqueInput;
  @Field(() => WebsiteVisitorUpdateInput, { nullable: false })
  data!: WebsiteVisitorUpdateInput;
}

export { UpdateWebsiteVisitorArgs as UpdateWebsiteVisitorArgs };
